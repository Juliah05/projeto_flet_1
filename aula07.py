...
class Task(UserControl):
    ...
    def build(self):
        ...
        self.edit_name = TextField(expand=1) #entrada de texto da edicao de tarefas
                ...
                Row(
                    ...
                    controls=[
                        IconButton(
                            ...
                            tooltip="Editar tarefa ", #texto de orientacao
                            on_click=self.edit_clicked,
                            icon_color=colors.GREEN,
                        ),
                        IconButton(
                            icon=icons.DELETE_OUTLINED,
                            tooltip="Deletar tarefa ",  # texto de orientacao
...
class Todoapp(UserControl):
    def build(self):
        ...
        self.items_letf = Text("0 tarefas adicionadas")
    ...
    def add_clicked(self, e):
        if self.new_task.value:
            julia= Task(self.new_task.value, self.task_status_change, self.task_delete)
            self.tasks.controls.append(julia)
            self.new_task.value=""
            self.new_task.focus()
            self.update()
    ...
    def update(self):
        ...
        for task in self.tasks.controls:
            ...
            if not task.completed:
                count +=1
        self.items_letf.value = f"{count} Tarefa(s) pendentes"
        super().update()
...
def main(page: Page):
    ...
    #adicionando a aplicacao na pagina
    page.add(app)
